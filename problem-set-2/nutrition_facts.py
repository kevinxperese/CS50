"""CS50P -- Problem Set 2: Nutrution Facts
...
welcome to download the posters, print, display and/or distribute them to consumers in close
...
FDA's poster for fruits, which is also available as text.
